...
class ISLGameEasy extends StatefulWidget {
  const ISLGameEasy({super.key});

  @override
  State<ISLGameEasy> createState() => _ISLGameEasyState();
}

class _ISLGameEasyState extends State<ISLGameEasy> {
      ...
      body: LayoutBuilder(builder: (context, constraints) {
        ...
        return Stack(
          children: [
            ...
            // ── Letter boxes — Row spaceEvenly, same as bg image layout ──
            Positioned(
              top: h * 0.655,
              left: 0,
              right: 0,
              ...
              child: Row(
                ...
                children: List.generate(letterOptions.length, (i) {
                  return GestureDetector(
                    onTap: () => _handleTap('letter', i),
                    behavior: HitTestBehavior.opaque,
                    child: _buildLetterBox(i, boxW, boxH),
                  );
                }),
              ),
            ),
