...
class MathGameH extends StatefulWidget {
  const MathGameH({super.key});

  @override
  State<MathGameH> createState() => _MathGameHState();
}

class _MathGameHState extends State<MathGameH> {
  int num1 = 0;
  int num2 = 0;
  List<int> options = [];
  int score = 0;
  ...
  void generateQuestion() {
    ...
    num1 = rng.nextInt(90) + 10; 
    num2 = rng.nextInt(90) + 10; 
    int correctAns = num1 + num2;

    Set<int> optionSet = {correctAns};
    while (optionSet.length < 4) {
      int variance = rng.nextInt(20) - 10;
      int wrongAns = correctAns + (variance == 0 ? 5 : variance);
  ...
  void _showGameOver() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          "Final Score: $score\n" + 
          (_timeLeft <= 0 ? "Time's up!" : wrongAnswers >= maxWrong ? "Out of lives!" : "Hard Mode finished!"),
